...
export default function DoctorRejectedAppointments() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <h1 className="text-3xl font-bold text-indigo-800 mb-6">My Rejected Appointments</h1>
